...
- API keys for LLM providers (Claude and/or Gemini)
...
LLM_MODEL_MEDIUM=gemini-3.6-flash
LLM_MODEL_HIGH=gemini-3.8-flash
```
...
llm_powerful = pick_llm("high") # Premium model for complex tasks
```
...
| `database` | Database name | `postgres_db` |
